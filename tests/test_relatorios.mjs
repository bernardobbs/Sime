...
export function createClient(){
  ...
  const SEC=[
    {id:'s1',numero:'0063',municipio:'Campo Maior',local_nome:'G.E. Treze',eleitores:300,rota_id:'r1',ativo:true},
  ...
  const ROTAS=[
    {id:'r1',codigo:'001',nome:'Rota 001',municipios:['Campo Maior'],itinerario:'Escola A; Escola B',urnas_estimadas:4,ativo:true},
  ...
  const LOGS=[
    {acao:'panico_energia',modulo:'mesario',secao_id:'s3',payload:{x:1},ts:'2026-10-04T09:00:00Z'},
...
check('distribuição: itinerário aparece', /Escola A/.test(dist), dist.replace(/\s+/g,' ').slice(0,120));
